...
#if defined(VK_ENABLE_BETA_EXTENSIONS)
//=== VK_NV_cuda_kernel_launch ===
template <> struct hash<VULKAN_HPP_NAMESPACE::CudaModuleNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CudaFunctionNV>;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
...
//=== VK_EXT_shader_object ===
template <> struct hash<VULKAN_HPP_NAMESPACE::ShaderEXT>;

//=== VK_KHR_pipeline_binary ===
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryKHR>;

//=== VK_EXT_device_generated_commands ===
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsLayoutEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ClearAttachment>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClearColorValue>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClearDepthStencilValue>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClearRect>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ClearValue>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingAttachmentInfo>;
...
//=== VK_VERSION_1_4 ===
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVulkan14Features>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVulkan14Properties>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorProperties>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryMapInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryUnmapInfo>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingAreaInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceImageSubresourceInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ImageSubresource2>;
template <> struct hash<VULKAN_HPP_NAMESPACE::SubresourceLayout2>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineCreateFlags2CreateInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::BufferUsageFlags2CreateInfo>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePushDescriptorProperties>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceDynamicRenderingLocalReadFeatures>;
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingAttachmentLocationInfo>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::BindMemoryStatus>;
template <> struct hash<VULKAN_HPP_NAMESPACE::BindDescriptorSetsInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PushConstantsInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PushDescriptorSetInfo>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::PushDescriptorSetWithTemplateInfo>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineProtectedAccessFeatures>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineRobustnessCreateInfo>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryToImageCopy>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ImageToMemoryCopy>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyMemoryToImageInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyImageToMemoryInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyImageToImageInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::HostImageLayoutTransitionInfo>;
template <> struct hash<VULKAN_HPP_NAMESPACE::SubresourceHostMemcpySize>;
template <>
...
//=== VK_KHR_video_encode_h264 ===
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264CapabilitiesKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersCreateInfoKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264PictureInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264DpbSlotInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264NaluSliceInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264ProfileInfoKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264QpKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264FrameSizeKHR>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264GopRemainingFrameInfoKHR>;

//=== VK_KHR_video_encode_h265 ===
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265CapabilitiesKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersCreateInfoKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersFeedbackInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265PictureInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265DpbSlotInfoKHR>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265NaluSliceSegmentInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265ProfileInfoKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265QpKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265FrameSizeKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoDecodeH264SessionParametersCreateInfoKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PerformanceCounterResultKHR>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::AndroidHardwareBufferFormatProperties2ANDROID>;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
template <> struct hash<VULKAN_HPP_NAMESPACE::DispatchGraphInfoAMDX>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DispatchGraphCountInfoAMDX>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::PipelineShaderStageNodeCreateInfoAMDX>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceOrHostAddressConstAMDX>;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
...
//=== VK_KHR_acceleration_structure ===
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceOrHostAddressKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceOrHostAddressConstKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AccelerationStructureGeometryKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoDecodeH265SessionParametersCreateInfoKHR>;
template <>
...
//=== VK_INTEL_performance_query ===
template <> struct hash<VULKAN_HPP_NAMESPACE::PerformanceValueDataINTEL>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PerformanceValueINTEL>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineExecutableStatisticKHR>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryMapPlacedInfoEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::DepthBiasInfoEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DepthBiasRepresentationInfoEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeQualityLevelInfoKHR>;
template <>
...
#if defined(VK_ENABLE_BETA_EXTENSIONS)
//=== VK_NV_cuda_kernel_launch ===
template <> struct hash<VULKAN_HPP_NAMESPACE::CudaModuleCreateInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CudaFunctionCreateInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CudaLaunchInfoNV>;
template <>
...
//=== VK_NV_low_latency ===
template <> struct hash<VULKAN_HPP_NAMESPACE::QueryLowLatencySupportNV>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::DescriptorDataEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DescriptorGetInfoEXT>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::FrameBoundaryEXT>;
...
//=== VK_EXT_opacity_micromap ===
template <> struct hash<VULKAN_HPP_NAMESPACE::MicromapBuildInfoEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyMicromapToMemoryInfoEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::CopyMemoryToMicromapInfoEXT>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterCullingShaderFeaturesHUAWEI>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterCullingShaderPropertiesHUAWEI>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceSchedulingControlsPropertiesARM>;

//=== VK_EXT_image_sliced_view_of_3d ===
template <>
struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageSlicedViewOf3DFeaturesEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::ImageViewSlicedCreateInfoEXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderPassStripeBeginInfoARM>;
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderPassStripeInfoARM>;
template <> struct hash<VULKAN_HPP_NAMESPACE::RenderPassStripeSubmitInfoARM>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::BindPipelineIndirectCommandNV>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderMaximalReconvergenceFeaturesKHR>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolveFeaturesANDROID>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolvePropertiesANDROID>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::AndroidHardwareBufferFormatResolvePropertiesANDROID>;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceRayTracingPositionFetchFeaturesKHR>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ShaderCreateInfoEXT>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::VertexInputBindingDescription2EXT>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::VertexInputAttributeDescription2EXT>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryKeyKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryDataKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryKeysAndDataKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryCreateInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryInfoKHR>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::ReleaseCapturedPipelineDataInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryDataInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineCreateInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineBinaryHandlesInfoKHR>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceExtendedSparseAddressSpaceFeaturesNV>;
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceExtendedSparseAddressSpacePropertiesNV>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceLegacyVertexAttributesPropertiesEXT>;

//=== VK_EXT_layer_settings ===
template <> struct hash<VULKAN_HPP_NAMESPACE::LayerSettingsCreateInfoEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::LayerSettingEXT>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT>;
...
//=== VK_NV_low_latency2 ===
template <> struct hash<VULKAN_HPP_NAMESPACE::LatencySleepModeInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::LatencySleepInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::SetLatencyMarkerInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::GetLatencyMarkerInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::LatencyTimingsFrameReportNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::LatencySubmissionPresentIdNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::SwapchainLatencyCreateInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::OutOfBandQueueTypeInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::LatencySurfaceCapabilitiesNV>;

//=== VK_KHR_cooperative_matrix ===
template <> struct hash<VULKAN_HPP_NAMESPACE::CooperativeMatrixPropertiesKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::MultiviewPerViewRenderAreasRenderPassBeginInfoQCOM>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceComputeShaderDerivativesPropertiesKHR>;

//=== VK_KHR_video_decode_av1 ===
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1ProfileInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1CapabilitiesKHR>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1SessionParametersCreateInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1PictureInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1DpbSlotInfoKHR>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1PictureInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1DpbSlotInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1ProfileInfoKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1QIndexKHR>;
template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1FrameSizeKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDevicePerStageDescriptorSetFeaturesNV>;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::BlitImageCubicWeightsInfoQCOM>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::SamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalMemoryScreenBufferFeaturesQNX>;
#endif /*VK_USE_PLATFORM_SCREEN_QNX*/
...
//=== VK_KHR_calibrated_timestamps ===
template <> struct hash<VULKAN_HPP_NAMESPACE::CalibratedTimestampInfoKHR>;
...
//=== VK_NV_display_stereo ===
template <> struct hash<VULKAN_HPP_NAMESPACE::DisplaySurfaceStereoCreateInfoNV>;
template <> struct hash<VULKAN_HPP_NAMESPACE::DisplayModeStereoPropertiesNV>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::VideoEncodeH265QuantizationMapCapabilitiesKHR>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceCommandBufferInheritanceFeaturesNV>;
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceDeviceGeneratedCommandsPropertiesEXT>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetInfoEXT>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::GeneratedCommandsInfoEXT>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsLayoutTokenEXT>;
template <>
...
template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsTokenDataEXT>;
template <>
struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetShaderLayoutInfoEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::GeneratedCommandsPipelineInfoEXT>;
template <> struct hash<VULKAN_HPP_NAMESPACE::GeneratedCommandsShaderInfoEXT>;
template <>
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceImageAlignmentControlFeaturesMESA>;
template <>
struct hash<
...
template <>
struct hash<
    VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeRobustnessFeaturesEXT>;
