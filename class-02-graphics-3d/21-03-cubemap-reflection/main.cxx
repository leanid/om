...
struct scene
{
    ...
    gles30::shader reflection_shader;
    ...
    gles30::mesh cube_sky_reflection;
...
scene::scene()
    ...
    , reflection_shader("res/reflection.vsh", "res/reflection.fsh")
    ...
    , cube_skybox{ create_mesh(cube_vertices, sizeof(cube_vertices) / 4 / 8,
                               { &tex_cubemap }) }
    , cube_sky_reflection{ create_mesh(
...
void scene::render(float delta_time)
{
    ...
    reflection_shader.set_uniform("camera_pos", camera.position());
    render_mesh(reflection_shader, camera, cube_sky_reflection,
