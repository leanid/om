...
int main(int /*argc*/, char* /*argv*/[])
{
    ...
    om::texture* texture = engine->create_texture(
        "./01-basic-game-dev/06-2-shader-multiply-matrix/tank.png");
    if (nullptr == texture)
    {
    ...
    while (continue_loop)
    {
        ...
        {
            std::ifstream file(
                "./01-basic-game-dev/06-2-shader-multiply-matrix/vert_pos.txt");
            assert(!!file);
        ...
        {
            std::ifstream file(
                "./01-basic-game-dev/06-2-shader-multiply-matrix/"
                "vert_pos_color.txt");
            assert(!!file);
