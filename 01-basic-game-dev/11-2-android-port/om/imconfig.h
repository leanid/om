...
//---- Don't define obsolete functions names. Consider enabling from time to
//time or when updating to reduce like hood of using already obsolete
...
//OpenClipboard() and others Win32 functions) #define
// IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS #define
// IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS

//---- Don't implement demo windows functionality
//(ShowDemoWindow()/ShowStyleEditor()/ShowUserGuide() methods will be empty)
//---- It is very strongly recommended to NOT disable the demo windows. Please
//read the comment at the top of imgui_demo.cpp to learn why. #define
// IMGUI_DISABLE_DEMO_WINDOWS

//---- Don't implement ImFormatString(), ImFormatStringV() so you can
//reimplement them yourself. #define IMGUI_DISABLE_FORMAT_STRING_FUNCTIONS

//---- Pack colors to BGRA instead of RGBA (remove need to post process vertex
//buffer in back ends) #define IMGUI_USE_BGRA_PACKED_COLOR
...
//---- Use 32-bit vertex indices (instead of default: 16-bit) to allow meshes
//with more than 64K vertices #define ImDrawIdx unsigned int
...
namespace ImGui
{
    void    Value(const char* prefix, const MyMatrix44& v, const char*
float_format = NULL);
}
*/
