...
typedef unsigned short stbrp_coord;
    ...
    //    'num_nodes' long
    //
    // You must call this function every time you start packing into a new
    // target.
    //
    ...
    //   or  2. call stbrp_allow_out_of_mem() defined below with
    //   'allow_out_of_mem = 1'
    //
    ...
    // sets. If you call init again, this will be reset to the default.
    ...
    //////////////////////////////////////////////////////////////////////////////
    //
    // the details of the following structures don't matter to you, but they
    // must be visible so you can handle the memory allocations for them
...
static int stbrp__skyline_find_min_y(
    stbrp_context* c, stbrp_node* first, int x0, int width, int* pwaste)
{
