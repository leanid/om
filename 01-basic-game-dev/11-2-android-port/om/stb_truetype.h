...
//   num-fonts-in-TTC function 1.12 (2016-10-25) suppress warnings about casting
//   away const with -Wcast-qual 1.11 (2016-04-02) fix unused-variable warning
    ...
    else if (numberOfContours == -1)
    {
        ...
        while (more)
        {
            ...
            if (comp_num_verts > 0)
            {
                ...
                {
                    STBTT_memcpy(
                        tmp, vertices, num_vertices * sizeof(stbtt_vertex));
                }
...
STBTT_DEF int stbtt_GetCodepointKernAdvance(const stbtt_fontinfo* info,
                                            ...
                                            int                   ch2)
{
    if (!info->kern) // if no kerning table, don't waste time looking up both
                     // codepoint->glyphs
    {
        return 0;
    }
