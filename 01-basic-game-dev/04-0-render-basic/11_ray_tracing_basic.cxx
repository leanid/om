...
int main(int argc, char** argv)
{
    ...
    scene.push_back(
        sphere_t{ .center_position=glm::vec3{ 0.f, -1.f, 3.f }, .color=red, .radius=1.f, .spec_reflection_exp=500.f, .reflective=0.2f });
    scene.push_back(
        sphere_t{ .center_position=glm::vec3{ 2.f, 0.f, 4.f }, .color=blue, .radius=1.f, .spec_reflection_exp=500.f, .reflective=0.3f });
    scene.push_back(
        sphere_t{ .center_position=glm::vec3{ -2.f, 0.f, 4.f }, .color=green, .radius=1.f, .spec_reflection_exp=10.f, .reflective=0.4f });
    scene.push_back(sphere_t{
        .center_position=glm::vec3{ 0.f, -5001.f, 0.f }, .color=yellow, .radius=5000.f, .spec_reflection_exp=1000.f, .reflective=0.5f });
    ...
    camera_t camera{ .rotation=glm::mat4{ 1.f }, .position=glm::vec3{ 0, 0, 0 } };
