...
{
    const size_t image_x = static_cast<size_t>(Cw / 2) + x;
    const size_t image_y = static_cast<size_t>(Ch / 2) - y;
...
float compute_lighting(const glm::vec3&             P, // NOLINT
                       const glm::vec3&             N,
                       const glm::vec3&             V,
                       const float                  specular_reflection_exp,
                       const std::vector<sphere_t>& objects,
