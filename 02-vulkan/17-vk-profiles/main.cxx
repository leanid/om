...
int main_cant_throw(int argc, char** argv)
{
    ...
    std::unique_ptr<sdl::SDL_Window, decltype(&sdl::DestroyWindow)> window(
        sdl::CreateWindow("17-vk-profiles", 800, 600, window_flags),
        sdl::DestroyWindow);
    ...
    try
    {
        ...
        std::vector<vertex> mesh_verticles = {
            {.pos{ 0.4f, -0.4f, 0.0f }, .col{1.0f, 0.0f, 0.0f}, .tex{1.0f, 0.f}},
            {.pos{ 0.4f, 0.4f, 0.0f },  .col{0.0f, 1.0f, 0.0f}, .tex{1.0f, 1.f}},
            {.pos{ -0.4f, 0.4f, 0.0f }, .col{0.0f, 0.0f, 1.0f}, .tex{0.0f, 1.f}},
            {.pos{ -0.4f, -0.4f, 0.0f}, .col{1.0f, 1.0f, 0.0f}, .tex{0.0f, 0.f}},

            {.pos{ 0.4f, -0.4f, -0.4f }, .col{1.0f, 0.0f, 0.0f}, .tex{1.0f, 0.f}},
            {.pos{ 0.4f, 0.4f, -0.4f },  .col{0.0f, 1.0f, 0.0f}, .tex{1.0f, 1.f}},
        ...
        om::vulkan::image image_mip_on(
            render,
            "02-vulkan/17-vk-profiles/model/viking_room.png",
            "viking_room.png_on",
            true);
        ...
        om::vulkan::mesh mesh = om::tinyobj::load_model(
            "02-vulkan/17-vk-profiles/model/viking_room.obj", render);
