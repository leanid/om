...
om::vertex blend_vertex(const om::vertex& vl, const om::vertex& vr, const float a)
{
	om::vertex r;
...
om::triangle blend(const om::triangle& tl, const om::triangle& tr, const float a)
{
	om::triangle r;
...
int main(int /*argc*/, char* /*argv*/ [])
{
    ...
    if (!engine->load_texture("tank.png"))
    {
    	return EXIT_FAILURE;
    }
