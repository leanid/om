...
int main(int /*argc*/, char* /*argv*/[])
{
    ...
    glVertexAttribPointer(
        0, 3, GL_FLOAT, GL_FALSE, (3 + 3) * sizeof(float), nullptr);
    gl_check();
    glEnableVertexAttribArray(0);
    gl_check();
    ...
    while (continue_loop)
    {
        ...
        // render object
        {
            ...
            material_diffuse   = properties.get_vec3("material_diffuse");
            material_specular  = properties.get_vec3("material_specular");

            material.set_uniform("material.ambient", material_ambient);
            material.set_uniform("material.diffuse", material_diffuse);
